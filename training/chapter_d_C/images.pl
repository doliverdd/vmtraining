...
$key = q/{displaymath}frac{partial^2C}{partialx^2}=frac{1}{partialx^2}bigg{C^k_{i+1,j}-2C^k_{i,j}+C^k_{i-1,j}bigg}{displaymath};MSF=1.6;AAT/;
...
$key = q/{displaymath}frac{partialC}{partialt}=frac{1}{trianglet}bigg{C^k+1_{i,j}-C^k_{i,j}bigg}{displaymath};MSF=1.6;AAT/;
$cached_env_img{$key} = q|<IMG
...
$key = q/{displaymath}frac{partial^2C}{partialy^2}=frac{1}{partialy^2}bigg{C^k_{i,j+1}-2C^k_{i,j}+C^k_{i,j-1}bigg}{displaymath};MSF=1.6;AAT/;
$cached_env_img{$key} = q|<IMG
