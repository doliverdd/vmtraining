...
\input /home/drewoliver/Documents/training/source/chapter_libs.aux
\makeatother
}
...
$\displaystyle \Psi({\bf r}) = \sum_{i=1}^{N}C_{i} \phi_{i}({\bf r}), \,\,\,
\phi_{i}({\bf r})=e^{-{\alpha}_{i}r^2}$%
...
\begin{displaymath}
\underline{H} \cdot \vec{C}=\epsilon \cdot \vec{C}
\end{displaymath}%
\lthtmldisplayZ
\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}
\underline{H} \cdot \vec{C}=\epsilon \cdot
\underline{S} \cdot \vec{C}
\end{displaymath}%
\lthtmldisplayZ
\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}
\underline{hmatrix}(N,N) \cdot \vec{C}(N)=\epsilon \cdot 
\underline{smatrix}(N,N) \cdot \vec{C}(N)
\end{displaymath}%
\lthtmldisplayZ
\lthtmlcheckvsize\clearpage}
