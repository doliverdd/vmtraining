...
{\newpage\clearpage
\lthtmlfigureA{align171}%
\begin{align}
 \frac{1}{\triangle t}\big(C^{k+1}_{i,j}-C^{k}_{i,j}\big)  &=D \frac{1}{\triangle x^2}\bigg\{C^k_{i+1,j}-2C^k_{i,j}+C^k_{i-1,j} \bigg\}\notag \\
 &+D \frac{1}{\triangle y^2}\bigg\{C^k_{i,j+1}-2C^k_{i,j}+C^k_{i,j-1}\bigg\}
\end{align}%
\lthtmlfigureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlfigureA{align191}%
\begin{align}
C^{k+1}_{i,j} =C^{k}_{i,j}&+D \frac{\triangle t}{\triangle  x^2}\bigg\{C^k_{i+1,j}-2C^k_{i,j}+C^k_{i-1,j}\bigg\}\notag\\
&+D \frac{\triangle t}{\triangle
